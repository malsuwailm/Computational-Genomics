...
############################################################################################################################################################################################################################################
	...
	INST_SRC_DIR="/home/themokona/development/genomics/project/ReadServer"    # This should be set to the absolute path to 'ReadServer' project directory created by 'git' (e.g. "/usr/local/ReadServer")
...
#..........................................................................................................................................................................................................................................#
	...
	##################################################################
		if [[ "${INST_START_AT}" -eq "${INST_STOP_AT}" ]] ; then
			...
			grep "ERR650" "${INST_SRC_DIR}/demo/ng.3281-S2.csv" | awk -F ',' '{print $3}' | sort -u | head -n "${INST_SMP}" > "${INST_DST}/list_of_sample_names"
			"${INST_BIN_DIR}/create_samples_hash" "${INST_DST}/list_of_sample_names" "${INST_DST}/list_of_sample_hash"
...
#..........................................................................................................................................................................................................................................#
	...
	while read sample
	do
		echo "wget -q ftp://ftp.sra.ebi.ac.uk/vol1/fastq/ERR189/$sample/${sample}_1.fastq.gz" >> tmp.commands
		echo "wget -q ftp://ftp.sra.ebi.ac.uk/vol1/fastq/ERR189/$sample/${sample}_2.fastq.gz" >> tmp.commands
